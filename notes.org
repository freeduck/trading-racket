...
** convert to JSON
#+BEGIN_SRC sh
  sqlite3 -line  2018-11-18-22\:21\:00-2019-02-18-22\:21\:00.db "select json_object('start', start, 'open', open) as ohcl from candles_EUR_XMR;" | awk -F"=" '{print $2}' | sed '/^$/d' | jq -s . > 2018.json
#+END_SRC
