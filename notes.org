...
"72.4375 79.5"
:end:
Using linear regression to filtere out poly regression where linear
makes a better fit.
...
** TODO least squares comparison between linear and poly models
Maybe look into "Polynomial least squares"
